    ...
    <div className="pt-9 flex flex-col gap-y-2 justify-center">
        ...
        <div className="flex justify-center items-center bg-red-500 hero-style py-5 gap-3 xl:gap-7">
          ...
          <div className="flex flex-col">
            <h3 className="uppercase font-light text-background text-2xl">I love Wing chun</h3>
            <p className="font-light text-foreground">Wing chun is nothing more than a perfect martial art, focused on speed, ideologie, weak points, and efficiency <Link className="link-style" href="https://www.youtube.com/@wingchunenligne5595">see more</Link></p>
          </div>
        </div>
