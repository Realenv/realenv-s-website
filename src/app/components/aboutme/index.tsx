...
const AboutMe = () => {
  return (
    <div className="flex hero-style gap-5 grid md:grid-cols-2 grid-cols-1 justify-center sm:flex-nowrap pt-5">
        <Image src="/realenv.svg" alt="RealEnv" width={256} height={256} className="w-auto h-auto rounded-full object-contain max-md:w-full"/>
