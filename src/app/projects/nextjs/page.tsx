...
export default function NextJSProjects (){
    return (
        <div id="biogrgaphy" className="mt-5 ax-w-[1250px] max-sm:flex-wrap px-10 gap-5 flex justify-center">
            ...
            <p className="auto-sizing-hero-p">My first complete project in next.js was to build this personnal website from A to Z without AI or any personnalized helps.</p>
