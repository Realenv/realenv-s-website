  ...
  return (
    <div className="max-w-[1250px] max-sm:flex-wrap px-10 gap-5 flex justify-center">
        ...
        <div className="flex flex-col gap-y-3.5">
          <p className="auto-sizing-hero-p">Hi, Just call me realenv, I would like to be more and more professional over the years, I am learning a lot of things, like coding in react, using next.js, i love rust, and I want to go to the ITMO university of St. Petersburg.</p>
