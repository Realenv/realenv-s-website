...
const HumanLanguagesBadges = (props: {includeBtns?: boolean}) => {
  return (
    <div className="flex flex-col gap-y-5 justify-center">
        ...
        <div className="flex justify-center items-center">
          <div className="grid 2xs:grid-cols-3 xs:grid-cols-2 grid-cols-1 gap-7 p-2 sm:p-7 md:grid-cols-5 max-xs:p-1 max-xs:gap-4">
            <OpenBadge color="hsl(220 100% 55%)" title="french" description="It is my native language" smallDescription="C1"/>
            <OpenBadge color="hsl(150 100% 45%)" title="arabic" description="It is my country's language" smallDescription="B2"/>
            <OpenBadge color="hsl(200 100% 55%)" title="english" description="It is my favorite language on the web" smallDescription="B1"/>
            <OpenBadge color="hsl(215 100% 25%)" title="russian" description="It is my most loved language" smallDescription="pre A1"/>
            <OpenBadge color="hsl(1 100% 55%)" title="chinese" description="It is my most needed language" smallDescription="pre A1"/>
          </div>
        </div>
