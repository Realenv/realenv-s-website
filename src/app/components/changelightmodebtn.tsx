...
const ChangeLightModeBtn = () => (
    <>
        ...
        <div className="hidden sm:block">
            <button className="fixed bottom-5 right-5 z-100 sm:relative sm:left-0 sm:bottom-0 sm:block rounded-full" onClick={changeLightMode}><div className="icon-to-invert"><Image src="/sun-moon.svg"  width={45} height={45} alt="change theme"/></div></button>
        </div>
    </>
)
